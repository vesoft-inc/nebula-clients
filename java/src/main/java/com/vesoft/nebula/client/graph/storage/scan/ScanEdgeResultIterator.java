...
public class ScanEdgeResultIterator extends ScanResultIterator {
    ...
    public static class ScanEdgeResultBuilder {
        ...
        public ScanEdgeResultIterator.ScanEdgeResultBuilder withPartLeaders(
                Map<Integer, HostAndPort> partLeaders) {
            this.partLeaders = partLeaders;
            return this;
        }

        public ScanEdgeResultIterator.ScanEdgeResultBuilder withRequest(ScanEdgeRequest request) {
            this.request = request;
            return this;
        }

        public ScanEdgeResultIterator.ScanEdgeResultBuilder withProcessor(EdgeProcessor processor) {
            this.processor = processor;
            return this;
        }

        public ScanEdgeResultIterator.ScanEdgeResultBuilder withMetaClient(MetaClient metaClient) {
            this.metaClient = metaClient;
            return this;
        }

        public ScanEdgeResultIterator.ScanEdgeResultBuilder withSpaceName(String spaceName) {
            this.spaceName = spaceName;
            return this;
        }

        public ScanEdgeResultIterator.ScanEdgeResultBuilder withPool(StorageConnPool pool) {
            this.pool = pool;
            return this;
        }
