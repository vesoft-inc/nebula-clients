...
import (
	...
	graph "github.com/vesoft-inc/nebula-clients/go/nebula/pkg/nebula/graph"
)
...
func (pool *ConnectionPool) InitPool(addresses []data.HostAddress, conf conf.PoolConfig, log logger.DefaultLogger) error {
