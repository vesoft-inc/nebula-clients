...
#   -a: Whether to disable the cxx11 abi, default value is `OFF`
#
...
package_one=ON
strip_enable="FALSE"
usage="Usage: ${0} -v <version> -n <ON/OFF> -s <TRUE/FALSE> -b <BRANCH> -a <ON/OFF>"
PROJECT_DIR="$(cd "$(dirname "$0")" && pwd)/.."
enablesanitizer="OFF"
build_type="Release"
branch="master"
disable_cxx11_abi='OFF'

while getopts v:n:s:b:d:a: opt;
do
    case $opt in
        v)
            version=$OPTARG
