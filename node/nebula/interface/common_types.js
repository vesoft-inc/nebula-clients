  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.I32) {
        this.microsec = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.DOUBLE) {
        this.fVal = input.readDouble().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.STRING) {
        this.sVal = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
nebula.Vertex.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.vid = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
nebula.Edge.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.dst = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 5:
      if (ftype == Thrift.Type.I64) {
        this.ranking = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
